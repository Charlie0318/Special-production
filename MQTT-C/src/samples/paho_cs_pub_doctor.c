...
int main(int argc, char** argv)
{
	...
	bee_opts.security = 6;
	bee_opts.pub_key="/home/lewatin1129/Special-production/MQTT-CPABE/cpabe_publickey_hospital";
	bee_opts.policy="doctor";
	//bee_opts.policy="jackie and a > 10";
	bee_opts.priv_key="/home/lewatin1129/Special-production/MQTT-CPABE/cpabe_secretkey_doctor";
